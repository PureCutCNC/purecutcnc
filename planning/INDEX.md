...
- [ISSUE_499_INTEGRATION_HANDOFF.md](ISSUE_499_INTEGRATION_HANDOFF.md) — fixture-pack and span-measurement contract, plus active execution ledger, for issue #499 (corner unwinding) on `feat/issue-499-corner-unwinding`.
