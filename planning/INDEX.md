...
- [CANVAS_HOOK_DEP_ARRAY_AUDIT_Plan.md](CANVAS_HOOK_DEP_ARRAY_AUDIT_Plan.md) — Audit extracted canvas hooks and `SketchCanvas.tsx` for whole unstable hook-return objects in React dependency arrays after the creation Dimensions regression. Fix only confirmed same-class bugs; otherwise document results.
