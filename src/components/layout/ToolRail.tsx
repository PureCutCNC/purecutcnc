      ...
      <nav className="tool-rail" aria-label="Tools">
        ...
        {sketchCommands.predicates.featureSketchEditActive && (
          <div className="tool-rail__section">
            ...
            <RailButton icon="trim" label="Trim" active={sketchCommands.sketchEdit.trim.active} onClick={sketchCommands.sketchEdit.trim.onActivate} />
            <RailButton icon="extend" label="Extend" active={sketchCommands.sketchEdit.extend.active} onClick={sketchCommands.sketchEdit.extend.onActivate} />
          </div>
        )}
      </nav>
