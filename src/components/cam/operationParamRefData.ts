...
const OP_PARAM_REF_KEY: Record<OperationParamRefKind, keyof typeof camEn> = {
  ...
  scallopHeight: 'cam.paramRef.scallopHeight',
  ...
  entryStrategy: 'cam.paramRef.entryStrategy',
  entryRampAngle: 'cam.paramRef.entryRampAngle',
  entryHelixDiameter: 'cam.paramRef.entryHelixDiameter',
  xyLeadStrategy: 'cam.paramRef.xyLeadStrategy',
  slotFeed: 'cam.paramRef.slotFeed',
  engagementMode: 'cam.paramRef.engagementMode',
  ...
  cornerRelief: 'cam.paramRef.cornerRelief',
