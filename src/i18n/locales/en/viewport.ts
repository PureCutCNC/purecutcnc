...
export const viewportEn = {
  ...
  'viewport.view3d.webglUnavailableTitle': "3D view isn't available",
  'viewport.view3d.webglUnavailableBody': 'This view requires WebGL2, which your browser or graphics driver did not provide. Try updating your browser or enabling hardware acceleration in its settings.',
  'viewport.view3d.webglLostTitle': '3D graphics context lost',
  'viewport.view3d.webglLostBody': 'Waiting for the browser to restore it. If this message persists, reload the app.',
