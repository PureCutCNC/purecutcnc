...
export const viewportEn = {
  ...
  'viewport.sim.engagementTooltip': 'Tool engagement percentage. 100% = full slot engagement (feed reduced), lower = less engagement (full feed).',
  'viewport.sim.playbackTitle': 'Tool playback',
