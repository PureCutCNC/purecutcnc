...
export const camEn = {
  ...
  'cam.operation.scallopHeightTooltip': 'Maximum cusp left between adjacent ball-endmill finish passes.',
  ...
  'cam.operation.xyLeadStrategy': 'XY approach & exit',
  'cam.operation.xyLeadNone': 'Direct',
  'cam.operation.xyLeadArc': 'Tangent arc',
  'cam.operation.xyLeadStrategyTooltip': 'Where the cutter reaches final depth and how it meets the contour. Direct drops straight onto the start point, which on a wall leaves a mark. Tangent arc stages the descent clear of the surface and curves onto it — and off it again — so the cutter never arrives by plunging.',
  ...
  'cam.paramRef.xyLeadStrategy': 'XY approach and exit reference',
