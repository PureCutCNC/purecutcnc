...
export const camEn = {
  ...
  'cam.plan.summary': 'Plan summary',
  'cam.plan.operations': 'operations',
  'cam.plan.tools': 'tools',
  'cam.plan.existingOperations': 'existing operations',
  'cam.plan.needsReview': 'need review',
  'cam.plan.recommendations': 'Recommended plan',
  'cam.plan.recalculate': 'Refresh recommendations',
  'cam.plan.recalculating': 'Recalculating…',
  'cam.plan.includeOperation': 'Include {name}',
  'cam.plan.moveUp': 'Move operation up',
  'cam.plan.moveDown': 'Move operation down',
  'cam.plan.dependencyBlocked': 'That move would put an operation before something it depends on.',
  'cam.plan.whyOperation': 'Why this operation?',
  'cam.plan.mainParameters': 'Main parameters',
  'cam.plan.toolInsufficientCutDepth': 'needs {required} {units} cutting depth; this tool provides {available} {units}',
  'cam.plan.toolExceedsDiameter': 'maximum cutter diameter is {maximum} {units}',
  'cam.plan.toolIncompatible': 'does not satisfy this operation’s constraints',
  'cam.plan.userSelectedTool': 'Tool selected by the user. Its saved defaults will seed speeds, feeds, stepdown, and stepover.',
  'cam.plan.missingTool': 'Choose a valid tool before creating this operation.',
  'cam.plan.blockingErrors': 'Fix these before creating operations',
  'cam.plan.reviewError': 'Review',
  'cam.plan.useRecommendedRestTool': 'Use recommended rest tool',
  'cam.plan.restStale': 'The source operation changed. Refresh recommendations to recalculate this rest operation.',
  'cam.plan.sharedSetup': 'Shared edge setup',
  'cam.plan.sharedTabs': 'Shared tabs',
  'cam.plan.sharedBy': 'Used once by all matching edge passes',
  'cam.plan.sharedByCount': 'Shared by {count} operations',
  'cam.plan.reuseTabs': 'Reuse the project tabs for these operations',
  'cam.plan.createTabs': 'Create {count} tabs once for these operations',
  ...
  'cam.plan.excludedCoverage': 'No enabled recommendation currently covers this feature.',
  'cam.plan.acknowledge': 'I understand these features will not be covered by the created operations.',
  'cam.plan.noRecommendations': 'No supported 2.5D recommendations were found.',
  'cam.plan.cancel': 'Cancel',
  'cam.plan.createOperations': 'Create {count} operations',
