...
export const camEn = {
  ...
  'cam.plan.subtitle': 'Review the recommended operations, tools, and shared setup before anything is added to the project.',
  ...
  'cam.plan.recalculate': 'Reset recommendations',
  ...
  'cam.plan.restStale': 'The source operation changed. Reset recommendations to recalculate this rest operation.',
