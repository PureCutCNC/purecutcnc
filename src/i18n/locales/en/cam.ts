...
export const camEn = {
  ...
  'cam.operation.xyLeadTangentS': 'Tangent S-curve',
  'cam.operation.xyLeadStrategyTooltip': 'Where the cutter reaches final depth and how it joins the first clearing ring. Direct drops straight onto the ring start. Tangent S-curve stages the descent clear of the ring and leads onto it — and off the last ring — along a tangent curve.',
