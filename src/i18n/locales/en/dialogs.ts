...
export const dialogsEn = {
  ...
  'dialogs.machineManager.comparisonTitle': 'This project uses an older copy',
  'dialogs.machineManager.comparisonBody': 'The project copy of “{name}” differs from the one in My Machines. Updating it may change exported G-code.',
