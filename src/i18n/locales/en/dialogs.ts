...
export const dialogsEn = {
  ...
  'dialogs.newProject.stockSize': 'Stock size ({units})',
  'dialogs.newProject.stockWidth': 'Width',
  'dialogs.newProject.stockHeight': 'Height',
  'dialogs.newProject.stockThickness': 'Thickness',
  'dialogs.newProject.stockDimensionsInvalid': 'Enter positive stock dimensions.',
  ...
  'dialogs.importGeometry.chooseFile': 'Choose SVG, DXF, STL, OBJ, STEP, or .camj',
  ...
  'dialogs.importGeometry.stepTolerance': 'Surface tolerance ({unit})',
  'dialogs.importGeometry.stepUnitsDeclared': 'Units declared in the file: {units}',
  'dialogs.importGeometry.stepUnitsConverted': 'The file declares {units}; its geometry is converted to millimeters.',
  ...
  'dialogs.importGeometry.error.unsupportedFormat': 'Unsupported import format. Use .svg, .dxf, .stl, .obj, .step, .stp, or .camj.',
  ...
  'dialogs.importGeometry.error.chooseFile': 'Choose an SVG, DXF, STL, OBJ, STEP, or .camj file to import.',
  ...
  'dialogs.importGeometry.error.stepTolerance': 'Surface tolerance must be a positive number.',
  'dialogs.importGeometry.error.stepFileTooLarge': 'STEP files larger than {limit} MB cannot be imported.',
  'dialogs.importGeometry.error.stepRuntimeUnavailable': 'The STEP importer could not be loaded. Check your connection and try again.',
  'dialogs.importGeometry.error.stepUnreadable': 'The STEP file could not be read.',
  'dialogs.importGeometry.error.stepNoGeometry': 'The STEP file contains no solids or surfaces to import.',
  'dialogs.importGeometry.error.stepTooManyTriangles': 'The model tessellates into more than {limit} triangles. Increase the surface tolerance and try again.',
  'dialogs.importGeometry.error.stepOutOfMemory': 'The STEP importer ran out of memory. Increase the surface tolerance or import a smaller model.',
  'dialogs.importGeometry.error.stepTessellationFailed': 'The STEP model could not be tessellated.',
  'dialogs.importGeometry.error.stepWorkerFailed': 'The STEP importer stopped unexpectedly. Try again.',
  ...
  'dialogs.importGeometry.tessellatingStep': 'Tessellating STEP model',
  ...
  'dialogs.export.error.generationFailed': 'Generation failed for "{operation}": {detail}',
  'dialogs.export.error.generationInterrupted': 'Generation for "{operation}" was cancelled or superseded. Change the selection or an option, then export again.',
  'dialogs.export.error.missingTool': 'Operation "{operation}" has no tool assigned.',
  'dialogs.export.error.stale': 'The export preview is out of date. Reopen the dialog and try again.',
  ...
  'dialogs.motionDebug.fit': 'Fit',
  'dialogs.motionDebug.reset': 'Reset',
  'dialogs.motionDebug.zoomSelection': 'Zoom selection',
  'dialogs.motionDebug.perLevel': 'Per level',
  'dialogs.motionDebug.rawMoves': 'Raw moves',
  'dialogs.motionDebug.optimizedMoves': 'Optimized moves',
  'dialogs.motionDebug.removed': 'Removed',
  'dialogs.motionDebug.linear': 'Linear',
  'dialogs.motionDebug.rapid': 'Rapid',
  'dialogs.motionDebug.arcCw': 'CW arcs',
  'dialogs.motionDebug.arcCcw': 'CCW arcs',
  'dialogs.motionDebug.verified': 'Verified — exported motion matches the generated path within tolerance.',
  'dialogs.motionDebug.warning': 'Warning',
  'dialogs.motionDebug.ineligibleDrilling': 'Drilling operations are not viewable as a 2D plan trace.',
  'dialogs.motionDebug.ineligibleNoCut': 'This operation produces no cutting motion to inspect.',
  'dialogs.motionDebug.ineligibleVariableZ': 'This operation has continuously varying cutting Z and cannot be shown as a flat 2.5D trace.',
  ...
  'dialogs.machineManager.emptyCustom': 'No custom machines yet. Duplicate a built-in machine or import one.',
  ...
  'dialogs.machineManager.builtinGroup': 'Built-in machines',
  'dialogs.machineManager.myMachines': 'My machines',
  'dialogs.machineManager.projectGroup': 'In this project',
  'dialogs.machineManager.notInLibrary': 'Not in my machines',
  'dialogs.machineManager.updateAvailable': 'Update available',
  'dialogs.machineManager.updateProjectCopy': 'Update project copy',
  'dialogs.machineManager.saveToMyMachines': 'Save to my machines',
  'dialogs.machineManager.projectCopyHint': 'This machine travels with the project. It stays usable for export even though it is not in your library.',
  'dialogs.machineManager.comparisonTitle': 'This project uses a different copy',
  'dialogs.machineManager.comparisonBodyBuiltin': 'The project copy of “{name}” differs from the built-in definition in this version of PureCutCNC. Updating it may change exported G-code.',
  'dialogs.machineManager.comparisonBodyCustom': 'The project copy of “{name}” differs from your saved copy in my machines. Updating it may change exported G-code.',
  'dialogs.machineManager.comparisonFields': 'Differences: {fields}',
  'dialogs.machineManager.field.id': 'identifier',
  ...
  'dialogs.machineManager.field.program': 'program header and footer',
  'dialogs.machineManager.field.workCoordinates': 'work coordinates',
  'dialogs.machineManager.field.motion': 'motion commands',
  'dialogs.machineManager.field.feedSpeed': 'feed and spindle',
  'dialogs.machineManager.field.toolChange': 'tool change',
  'dialogs.machineManager.field.cannedCycles': 'canned cycles',
  'dialogs.machineManager.field.coolant': 'coolant',
  'dialogs.machineManager.field.stop': 'program end',
  'dialogs.machineManager.field.builtin': 'ownership',
  'dialogs.machineUpdate.title': 'Machine definition update available',
  'dialogs.machineUpdate.body': 'This project uses an older copy of “{name}.” Updating it may change exported G-code.',
  'dialogs.machineUpdate.review': 'Review update',
  'dialogs.machineUpdate.keep': 'Keep project copy',
  'dialogs.machineUpdate.update': 'Update project copy',
