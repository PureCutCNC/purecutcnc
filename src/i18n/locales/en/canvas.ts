...
export const canvasEn = {
  ...
  'canvas.textLayout.step.placeText': 'Click the sketch to place the text',
  'canvas.textLayout.step.pickCenter': 'Click the centre of the circle',
  'canvas.textLayout.step.setRadius': 'Move to set the radius and angle, then click',
  'canvas.textLayout.step.needGuide': 'Pick a guide outline to run the text along',
  'canvas.textLayout.step.configure': 'Adjust the run, then create',
  ...
  'canvas.textLayout.direction.cw': 'Clockwise (outside)',
  'canvas.textLayout.direction.ccw': 'Anticlockwise (inside)',
  ...
  'canvas.textLayout.create': 'Create',
