...
export const canvasEn = {
  ...
  'canvas.edit.step.default': 'Drag nodes, or click a segment to edit its dimensions',
  'canvas.edit.move': 'Move',
  'canvas.edit.finish': 'Finish editing',
  'canvas.edit.cancelSession': 'Cancel editing',
  'canvas.edit.done.addPoint': 'Done adding points',
  'canvas.edit.done.deletePoint': 'Done deleting points',
  'canvas.edit.done.deleteSegment': 'Done deleting segments',
  'canvas.edit.done.disconnect': 'Done splitting',
  'canvas.edit.done.fillet': 'Done rounding',
  'canvas.edit.done.chamfer': 'Done chamfering',
  'canvas.edit.done.trim': 'Done trimming',
  'canvas.edit.done.extend': 'Done extending',
  'canvas.edit.inspector.segment': 'Selected segment',
  'canvas.edit.apply': 'Finish editing',
  'canvas.edit.cancel': 'Cancel editing',
  ...
  'canvas.textLayout.changeCenter': 'Change center',
  'canvas.textLayout.step.pickCenter': 'Click a center point on the sketch — Esc cancels',
  'canvas.textLayout.step.needCenter': 'Pick the circle centre, then apply',
  'canvas.textLayout.error.centerRequired': 'Pick a center point first.',
  'canvas.textLayout.mode': 'Layout',
  'canvas.textLayout.mode.horizontal': 'Horizontal',
  'canvas.textLayout.mode.arc': 'On a circle',
  'canvas.textLayout.mode.path': 'Along a path',
  'canvas.textLayout.radius': 'Radius',
  'canvas.textLayout.angle': 'Angle',
  'canvas.textLayout.sweep': 'Sweep',
  'canvas.textLayout.direction': 'Direction',
  'canvas.textLayout.direction.cw': 'Clockwise (over the top)',
  'canvas.textLayout.direction.ccw': 'Anticlockwise (under the bottom)',
  'canvas.textLayout.guide': 'Guide',
  'canvas.textLayout.pickGuide': 'Pick guide',
  'canvas.textLayout.changeGuide': 'Change guide',
  'canvas.textLayout.cancelPicking': 'Cancel picking',
  'canvas.textLayout.startOffset': 'Start offset',
  'canvas.textLayout.endOffset': 'End offset',
  'canvas.textLayout.reverse': 'Reverse direction',
  'canvas.textLayout.anchor': 'Anchor',
  'canvas.textLayout.anchor.start': 'Start',
  'canvas.textLayout.anchor.center': 'Centre',
  'canvas.textLayout.anchor.end': 'End',
  'canvas.textLayout.fit': 'Fit',
  'canvas.textLayout.fit.natural': 'Keep text size',
  'canvas.textLayout.fit.fill': 'Fill the span',
  'canvas.textLayout.orientation': 'Orientation',
  'canvas.textLayout.orientation.fixed': 'Fixed',
  'canvas.textLayout.orientation.follow': 'Follow the curve',
  'canvas.textLayout.effectiveSize': 'Cuts at {size} tall',
  'canvas.textLayout.create': 'Apply',
  'canvas.textLayout.error.guideRequired': 'Pick a guide outline first.',
  'canvas.textLayout.error.overflow': 'The text is longer than the span. Set the fit to fill the span, or widen the span.',
  ...
  'canvas.featureDistribution.rows': 'Rows',
  'canvas.featureDistribution.columns': 'Columns',
  'canvas.featureDistribution.spacingX': 'X spacing',
  'canvas.featureDistribution.spacingY': 'Y spacing',
  'canvas.featureDistribution.center': 'Center',
  'canvas.featureDistribution.centerPicked': 'Point selected',
  'canvas.featureDistribution.centerNotPicked': 'Choose a point on the sketch',
  'canvas.featureDistribution.instanceCount': 'Instances (incl. original)',
  'canvas.featureDistribution.sweep': 'Sweep',
  'canvas.featureDistribution.guide': 'Guide',
  'canvas.featureDistribution.pickGuide': 'Pick guide',
  'canvas.featureDistribution.changeGuide': 'Change guide',
  'canvas.featureDistribution.pickCenter': 'Pick center',
  'canvas.featureDistribution.changeCenter': 'Change center',
  'canvas.featureDistribution.pickCenterHint': 'Click a center point on the sketch outside this dialog. Drag this panel if it covers the point.',
  'canvas.featureDistribution.pickGuideHint': 'Click a separate guide outline on the sketch outside this dialog. Drag this panel if it covers the guide.',
  'canvas.featureDistribution.cancelPicking': 'Cancel picking',
  'canvas.featureDistribution.orientation': 'Orientation',
  'canvas.featureDistribution.fixedOrientation': 'Fixed',
  'canvas.featureDistribution.followOrientation': 'Follow direction',
  'canvas.featureDistribution.fixedOrientationHint': 'Keeps each copy at its source rotation.',
  'canvas.featureDistribution.followOrientationHint': 'Rotates each copy to the radial direction or path tangent.',
  'canvas.featureDistribution.startScale': 'Start scale %',
  'canvas.featureDistribution.endScale': 'End scale %',
  'canvas.featureDistribution.startOffset': 'Start offset',
  'canvas.featureDistribution.endOffset': 'End offset',
  'canvas.featureDistribution.create': 'Create copies',
  'canvas.featureDistribution.error.invalidGrid': 'Use at least two grid cells.',
  'canvas.featureDistribution.error.invalidCount': 'Set a valid copy count.',
  'canvas.featureDistribution.error.invalidScale': 'Scale values must be positive.',
  'canvas.featureDistribution.error.centerOverlap': 'Move the radial center away from the source.',
  'canvas.featureDistribution.error.centerRequired': 'Pick a center point before creating copies.',
  'canvas.featureDistribution.error.guideRequired': 'Choose a separate guide path.',
  'canvas.featureDistribution.error.guideEmpty': 'The guide has no usable length.',
  'canvas.featureDistribution.error.invalidOffsets': 'Offsets must stay within the guide.',
  // ── Sheet nesting (issue #741) ──
  'canvas.nest.title': 'Nest on stock',
  'canvas.nest.step.configure': 'Choose how many parts and how far apart, then nest',
  'canvas.nest.step.running': 'Nesting…',
  'canvas.nest.running': 'Nesting… {elapsed}',
  'canvas.nest.running.progress.one': 'Nesting… {done} of {count} part · {elapsed}',
  'canvas.nest.running.progress.other': 'Nesting… {done} of {count} parts · {elapsed}',
  'canvas.nest.took': 'Took {elapsed}.',
  'canvas.nest.part.one': '{count} feature in the part',
  'canvas.nest.part.other': '{count} features in the part',
  'canvas.nest.parts.one': '{count} part',
  'canvas.nest.parts.other': '{count} parts',
  'canvas.nest.partsList': 'Parts ({count})',
  'canvas.nest.existing': 'nested as {name}',
  'canvas.nest.quantity': 'Parts on sheet',
  'canvas.nest.quantityAll': 'All parts',
  'canvas.nest.quantityFor': 'Parts on sheet: {name}',
  'canvas.nest.gap': 'Gap ({units})',
  ...
  'canvas.nest.margins': 'Margins ({units})',
  'canvas.nest.marginsAll': 'All margins ({units})',
  'canvas.nest.margin.top': 'Top',
  'canvas.nest.margin.bottom': 'Bottom',
  'canvas.nest.margin.left': 'Left',
  'canvas.nest.margin.right': 'Right',
  'canvas.nest.marginFor': '{side} margin ({units})',
  'canvas.nest.marginsHint': 'Margins are the uncut stock kept at each edge.',
  'canvas.nest.error.marginInvalid': 'Margins must be 0 or more.',
  'canvas.nest.error.marginsNoRoom': 'The margins leave no room on the stock.',
  ...
  'canvas.nest.run': 'Nest',
  'canvas.nest.renest': 'Nest again',
  'canvas.nest.stop': 'Stop',
  'canvas.nest.discard': 'Discard nest',
  'canvas.nest.accept': 'Accept nest',
  'canvas.nest.result.all': 'All {placed} parts fit on the stock.',
  'canvas.nest.result.partial': '{placed} of {requested} parts fit, {missing} did not.',
  'canvas.nest.result.missing': 'Did not fit: {list}.',
  'canvas.nest.result.tabs': 'Tabs do not follow moved or copied parts, so re-run automatic tab placement.',
  'canvas.nest.refusal.empty': 'Select the part to nest.',
  'canvas.nest.refusal.locked': 'The part contains a locked feature. Unlock it to nest.',
  'canvas.nest.refusal.model': 'Imported models cannot be nested yet.',
  'canvas.nest.refusal.externalConstraint': 'A feature in the part is constrained to geometry outside it. Remove that constraint to nest.',
  'canvas.nest.refusal.noClosedGeometry': 'The selection has no closed outline to nest.',
  'canvas.nest.error.quantity': 'Enter whole numbers of parts, at least 1 each, and at least one copy to make when keeping the originals.',
  'canvas.nest.error.gapMissing': 'Enter the gap between parts.',
  'canvas.nest.error.gapBelowTool': 'The gap cannot be smaller than the cutter needs.',
  'canvas.nest.error.noStock': 'The stock outline cannot be used as a sheet.',
  'canvas.nest.improve': 'Keep improving',
  'canvas.nest.step.improving': 'Looking for a better layout…',
  'canvas.nest.improve.tried.one': '{count} layout tried.',
  'canvas.nest.improve.tried.other': '{count} layouts tried.',
  'canvas.nest.improve.gain': 'The best uses {percent}% less area than the first.',
  'canvas.nest.improve.more.one': 'It fits {count} more part.',
  'canvas.nest.improve.more.other': 'It fits {count} more parts.',
  'canvas.nest.improve.none': 'No better layout yet.',
  'canvas.nest.improve.searching': 'Searching for {elapsed}.',
