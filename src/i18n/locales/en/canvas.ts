...
export const canvasEn = {
  ...
  'canvas.featureDistribution.startAngle': 'Start angle',
  ...
  'canvas.featureDistribution.pickCenterHint': 'Click the desired center point on the sketch.',
  'canvas.featureDistribution.pickGuideHint': 'Click the separate guide’s visible outline on the sketch.',
