...
export const dialogsDe: Record<keyof typeof dialogsEn, string> = {
  ...
  'dialogs.newProject.stockSize': 'Rohteilgröße ({units})',
  'dialogs.newProject.stockWidth': 'Breite',
  'dialogs.newProject.stockHeight': 'Höhe',
  'dialogs.newProject.stockThickness': 'Dicke',
  'dialogs.newProject.stockDimensionsInvalid': 'Geben Sie positive Rohteilmaße ein.',
  ...
  'dialogs.importGeometry.chooseFile': 'SVG, DXF, STL, OBJ, STEP oder .camj wählen',
  ...
  'dialogs.importGeometry.stepTolerance': 'Oberflächentoleranz ({unit})',
  'dialogs.importGeometry.stepUnitsDeclared': 'In der Datei angegebene Einheiten: {units}',
  'dialogs.importGeometry.stepUnitsConverted': 'Die Datei gibt {units} an; die Geometrie wird in Millimeter umgerechnet.',
  ...
  'dialogs.importGeometry.error.unsupportedFormat': 'Nicht unterstütztes Importformat. Verwenden Sie .svg, .dxf, .stl, .obj, .step, .stp oder .camj.',
  ...
  'dialogs.importGeometry.error.chooseFile': 'Wählen Sie eine SVG-, DXF-, STL-, OBJ-, STEP- oder .camj-Datei zum Importieren.',
  ...
  'dialogs.importGeometry.error.stepTolerance': 'Die Oberflächentoleranz muss eine positive Zahl sein.',
  'dialogs.importGeometry.error.stepFileTooLarge': 'STEP-Dateien über {limit} MB können nicht importiert werden.',
  'dialogs.importGeometry.error.stepRuntimeUnavailable': 'Der STEP-Import konnte nicht geladen werden. Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.',
  'dialogs.importGeometry.error.stepUnreadable': 'Die STEP-Datei konnte nicht gelesen werden.',
  'dialogs.importGeometry.error.stepNoGeometry': 'Die STEP-Datei enthält keine Volumenkörper oder Flächen zum Importieren.',
  'dialogs.importGeometry.error.stepTooManyTriangles': 'Das Modell ergibt mehr als {limit} Dreiecke. Erhöhen Sie die Oberflächentoleranz und versuchen Sie es erneut.',
  'dialogs.importGeometry.error.stepOutOfMemory': 'Dem STEP-Import ist der Speicher ausgegangen. Erhöhen Sie die Oberflächentoleranz oder importieren Sie ein kleineres Modell.',
  'dialogs.importGeometry.error.stepTessellationFailed': 'Das STEP-Modell konnte nicht trianguliert werden.',
  'dialogs.importGeometry.error.stepWorkerFailed': 'Der STEP-Import wurde unerwartet beendet. Versuchen Sie es erneut.',
  'dialogs.importGeometry.error.stepDetail': '{message} Details: {detail}',
  ...
  'dialogs.importGeometry.tessellatingStep': 'STEP-Modell wird trianguliert',
  ...
  'dialogs.export.error.generationFailed': 'Generierung für „{operation}" fehlgeschlagen: {detail}',
  'dialogs.export.error.generationInterrupted': 'Die Generierung für „{operation}" wurde abgebrochen oder ersetzt. Ändern Sie die Auswahl oder eine Option und exportieren Sie erneut.',
  'dialogs.export.error.missingTool': 'Der Operation „{operation}" ist kein Werkzeug zugewiesen.',
  'dialogs.export.error.stale': 'Die Exportvorschau ist veraltet. Öffnen Sie den Dialog erneut und versuchen Sie es noch einmal.',
  ...
  'dialogs.motionDebug.fit': 'Anpassen',
  'dialogs.motionDebug.reset': 'Zurücksetzen',
  'dialogs.motionDebug.zoomSelection': 'Auswahl zoomen',
  'dialogs.motionDebug.perLevel': 'Pro Ebene',
  'dialogs.motionDebug.rawMoves': 'Rohe Bewegungen',
  'dialogs.motionDebug.optimizedMoves': 'Optimierte Bewegungen',
  'dialogs.motionDebug.removed': 'Entfernt',
  'dialogs.motionDebug.linear': 'Linear',
  'dialogs.motionDebug.rapid': 'Eilgang',
  'dialogs.motionDebug.arcCw': 'CW-Bögen',
  'dialogs.motionDebug.arcCcw': 'CCW-Bögen',
  'dialogs.motionDebug.verified': 'Verifiziert — die exportierte Bewegung stimmt innerhalb der Toleranz mit dem generierten Pfad überein.',
  'dialogs.motionDebug.warning': 'Warnung',
  'dialogs.motionDebug.ineligibleDrilling': 'Bohroperationen können nicht als 2D-Plan-Spur dargestellt werden.',
  'dialogs.motionDebug.ineligibleNoCut': 'Diese Operation erzeugt keine schneidende Bewegung zum Prüfen.',
  'dialogs.motionDebug.ineligibleVariableZ': 'Diese Operation hat eine kontinuierlich variierende Schnitt-Z und kann nicht als flache 2.5D-Spur gezeigt werden.',
  ...
  'dialogs.machineManager.emptyCustom': 'Noch keine eigenen Maschinen. Duplizieren Sie eine integrierte Maschine oder importieren Sie eine.',
  ...
  'dialogs.machineManager.builtinGroup': 'Integrierte Maschinen',
  'dialogs.machineManager.myMachines': 'Meine Maschinen',
  'dialogs.machineManager.projectGroup': 'In diesem Projekt',
  'dialogs.machineManager.notInLibrary': 'Nicht in „Meine Maschinen“',
  'dialogs.machineManager.updateAvailable': 'Aktualisierung verfügbar',
  'dialogs.machineManager.updateProjectCopy': 'Projektkopie aktualisieren',
  'dialogs.machineManager.saveToMyMachines': 'In „Meine Maschinen“ speichern',
  'dialogs.machineManager.projectCopyHint': 'Diese Maschine ist im Projekt gespeichert. Sie bleibt für den Export nutzbar, auch wenn sie nicht in Ihrer Bibliothek ist.',
  'dialogs.machineManager.comparisonTitle': 'Dieses Projekt verwendet eine abweichende Kopie',
  'dialogs.machineManager.comparisonBodyBuiltin': 'Die Projektkopie von „{name}“ unterscheidet sich von der integrierten Definition dieser PureCutCNC-Version. Eine Aktualisierung kann den exportierten G-Code ändern.',
  'dialogs.machineManager.comparisonBodyCustom': 'Die Projektkopie von „{name}“ unterscheidet sich von Ihrer gespeicherten Kopie in „Meine Maschinen“. Eine Aktualisierung kann den exportierten G-Code ändern.',
  'dialogs.machineManager.comparisonFields': 'Unterschiede: {fields}',
  'dialogs.machineManager.field.id': 'Kennung',
  'dialogs.machineManager.field.name': 'Name',
  ...
  'dialogs.machineManager.field.program': 'Programmkopf und -fuß',
  'dialogs.machineManager.field.workCoordinates': 'Werkstückkoordinaten',
  'dialogs.machineManager.field.motion': 'Bewegungsbefehle',
  'dialogs.machineManager.field.feedSpeed': 'Vorschub und Spindel',
  'dialogs.machineManager.field.toolChange': 'Werkzeugwechsel',
  'dialogs.machineManager.field.cannedCycles': 'Festzyklen',
  'dialogs.machineManager.field.coolant': 'Kühlmittel',
  'dialogs.machineManager.field.stop': 'Programmende',
  'dialogs.machineManager.field.builtin': 'Zugehörigkeit',
  'dialogs.machineUpdate.title': 'Aktualisierung der Maschinendefinition verfügbar',
  'dialogs.machineUpdate.body': 'Dieses Projekt verwendet eine ältere Kopie von „{name}“. Eine Aktualisierung kann den exportierten G-Code ändern.',
  'dialogs.machineUpdate.review': 'Aktualisierung prüfen',
  'dialogs.machineUpdate.keep': 'Projektkopie behalten',
  'dialogs.machineUpdate.update': 'Projektkopie aktualisieren',
}
