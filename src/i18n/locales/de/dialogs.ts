...
export const dialogsDe: Record<keyof typeof dialogsEn, string> = {
  ...
  'dialogs.machineManager.comparisonTitle': 'Dieses Projekt verwendet eine ältere Kopie',
  'dialogs.machineManager.comparisonBody': 'Die Projektkopie von „{name}“ unterscheidet sich von der in „Meine Maschinen“. Eine Aktualisierung kann den exportierten G-Code ändern.',
