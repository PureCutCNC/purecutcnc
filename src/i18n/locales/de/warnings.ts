...
export const warningsDe: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.edgeTrochoidalSmoothTabFallback': 'Haltesteg „{name}" ist auf Weich gesetzt, wird bei trochoidaler Kantenbearbeitung aber als Rechteckig gefräst. Der Werkzeugweg stuft über diesen Steg, statt zu rampen.',
  ...
  'warnings.carveTrochoidalMoveBudget': 'Trochoidale Gravur überschreitet das Operationslimit von 500.000 Punkten nahe ({x}, {y}).',
  'warnings.carveTrochoidalEntryBudget': 'Der trochoidale Gravur-Einstieg nahe ({x}, {y}) überschreitet das Einstiegspunktlimit.',
