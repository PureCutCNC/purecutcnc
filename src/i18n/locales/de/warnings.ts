...
export const warningsDe: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.edgeTrochoidalWidthTooSmall': 'Die trochoidale Schnittbreite muss mindestens dem 1,15-Fachen des Werkzeugdurchmessers entsprechen.',
  'warnings.edgeTrochoidalWidthNarrow': 'Die trochoidale Schnittbreite ist schmal; mindestens das 1,25-Fache des Werkzeugdurchmessers wird empfohlen.',
  'warnings.edgeTrochoidalWidthLeavesCore': 'Die trochoidale Schnittbreite ist mehr als doppelt so groß wie der Werkzeugdurchmesser; jeder Helix-Einstieg lässt einen ungeschnittenen Kern zurück, den die folgenden Schleifen durchpflügen müssen. Schnittbreite verringern oder Einstieg vorbohren.',
  ...
  'warnings.edgeTrochoidalAdvanceDegenerate': 'Der trochoidale Vorschub pro Umlauf ist nahe ({x}, {y}) zu klein für diesen Fräser: Die Bahn rückt pro Umlauf um weniger als 1 % des Fräserdurchmessers vor und schneidet dasselbe Material immer wieder. Erhöhen Sie den Vorschub pro Umlauf.',
  'warnings.edgeTrochoidalMoveBudget': 'Trochoidales Fräsen benötigt mehr Punkte, als eine Operation zulässt. Erhöhen Sie den Vorschub pro Umlauf, erhöhen Sie die Zustellung für weniger Z-Ebenen oder verwenden Sie einen größeren Fräser.',
  'warnings.edgeTrochoidalEntryBudget': 'Der trochoidale Einstieg nahe ({x}, {y}) passt nicht mehr in das verbleibende Punktbudget der Operation. Erhöhen Sie den Vorschub pro Umlauf, erhöhen Sie die Zustellung für weniger Z-Ebenen oder verwenden Sie einen größeren Fräser.',
  ...
  'warnings.carveTrochoidalWidthTooSmall': 'Die trochoidale Gravur-Schnittbreite muss mindestens dem 1,15-Fachen des Werkzeugdurchmessers entsprechen.',
  'warnings.carveTrochoidalWidthNarrow': 'Die trochoidale Gravur-Schnittbreite ist schmal; mindestens das 1,25-Fache des Werkzeugdurchmessers wird empfohlen.',
  'warnings.carveTrochoidalWidthLeavesCore': 'Die trochoidale Gravur-Schnittbreite ist mehr als doppelt so groß wie der Werkzeugdurchmesser; jeder Helix-Einstieg lässt einen ungeschnittenen Kern zurück, den die folgenden Schleifen durchpflügen müssen. Schnittbreite verringern oder Einstieg vorbohren.',
  'warnings.carveTrochoidalAdvanceRange': 'Der trochoidale Gravur-Vorschub muss größer als 0 und höchstens ein Werkzeugdurchmesser sein.',
  'warnings.carveTrochoidalEntryStrategyUnsupported': 'Trochoidale Gravur unterstützt nur Helix- oder Eintauch-Einstiege.',
  'warnings.carveTrochoidalInvalidGuide': 'Der Gravurpfad nahe ({x}, {y}) ist keine gültige trochoidale Führung.',
  'warnings.carveTrochoidalAdvanceDegenerate': 'Der Vorschub pro Umlauf der trochoidalen Gravur ist nahe ({x}, {y}) zu klein für diesen Fräser: Die Bahn rückt pro Umlauf um weniger als 1 % des Fräserdurchmessers vor und schneidet dasselbe Material immer wieder. Erhöhen Sie den Vorschub pro Umlauf.',
  ...
  'warnings.restTrochoidalUnsupported': 'Restbearbeitung ist für trochoidale Konturfräsung nicht verfügbar, weil ihr ausgefräster Kanal noch nicht als Restregion dargestellt werden kann.',
}
