...
export const bookletDe: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.cornerRelief.tBone': 'T-Bone (Nut von einem vollen Fräserradius in eine Wand)',
  'booklet.cornerRelief.longestEdge': 'T-Bone an der längsten Kante (Nut von einem vollen Fräserradius in diese Wand)',
  ...
  'booklet.label.edgeStrategy': 'Strategie',
  'booklet.label.trochoidalCutWidth': 'Trochoidale Schnittbreite',
  'booklet.label.trochoidalAdvance': 'Vorschub pro Umlauf',
