...
export const bookletDe: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.engagementMode.engagementFeed': 'Nach Eingriff',
  ...
  'booklet.label.entryStrategy': 'Eintauchstrategie',
  'booklet.label.xyLeadStrategy': 'XY-An- und Abfahrt',
  'booklet.entryStrategy.helix': 'Helix',
  'booklet.entryStrategy.ramp': 'Rampe',
  'booklet.xyLead.arc': 'Tangentialer Bogen',
  ...
  'booklet.label.engagementMode': 'Vorschubreduzierung',
