...
export const viewportDe: Record<keyof typeof viewportEn, string> = {
  ...
  'viewport.sim.engagementLabel': 'Eingriff',
  'viewport.sim.engagementTooltip': 'Werkzeugeingriff in Prozent. 100 % = volle Nut-Eingriff (Vorschub reduziert), niedriger = weniger Eingriff (voller Vorschub).',
  'viewport.sim.playbackTitle': 'Werkzeug-Wiedergabe',
