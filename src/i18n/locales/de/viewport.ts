...
export const viewportDe: Record<keyof typeof viewportEn, string> = {
  ...
  'viewport.view3d.webglUnavailableTitle': '3D-Ansicht ist nicht verfügbar',
  'viewport.view3d.webglUnavailableBody': 'Diese Ansicht benötigt WebGL2, das Ihr Browser oder Grafiktreiber nicht bereitgestellt hat. Aktualisieren Sie Ihren Browser oder aktivieren Sie die Hardwarebeschleunigung in dessen Einstellungen.',
  'viewport.view3d.webglLostTitle': '3D-Grafikkontext verloren',
  'viewport.view3d.webglLostBody': 'Warten auf Wiederherstellung durch den Browser. Falls diese Meldung bestehen bleibt, laden Sie die App neu.',
