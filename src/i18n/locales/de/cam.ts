...
export const camDe: Record<keyof typeof camEn, string> = {
  ...
  'cam.plan.summary': 'Planzusammenfassung',
  'cam.plan.operations': 'Operationen',
  'cam.plan.tools': 'Werkzeuge',
  'cam.plan.existingOperations': 'bestehende Operationen',
  'cam.plan.needsReview': 'zu prüfen',
  'cam.plan.recommendations': 'Empfohlener Plan',
  'cam.plan.recalculate': 'Empfehlungen aktualisieren',
  'cam.plan.recalculating': 'Wird neu berechnet…',
  'cam.plan.includeOperation': '{name} einschließen',
  'cam.plan.moveUp': 'Operation nach oben',
  'cam.plan.moveDown': 'Operation nach unten',
  'cam.plan.dependencyBlocked': 'Dadurch würde eine Operation vor einer Abhängigkeit stehen.',
  'cam.plan.whyOperation': 'Warum diese Operation?',
  'cam.plan.mainParameters': 'Hauptparameter',
  'cam.plan.toolInsufficientCutDepth': 'benötigt {required} {units} Schneidtiefe; dieses Werkzeug bietet {available} {units}',
  'cam.plan.toolExceedsDiameter': 'maximaler Fräserdurchmesser ist {maximum} {units}',
  'cam.plan.toolIncompatible': 'erfüllt die Anforderungen dieser Operation nicht',
  'cam.plan.userSelectedTool': 'Vom Benutzer gewähltes Werkzeug. Seine gespeicherten Werte setzen Drehzahl, Vorschübe, Zustellung und Bahnabstand.',
  'cam.plan.missingTool': 'Wählen Sie ein gültiges Werkzeug, bevor Sie diese Operation erstellen.',
  'cam.plan.blockingErrors': 'Vor dem Erstellen der Operationen beheben',
  'cam.plan.reviewError': 'Prüfen',
  'cam.plan.useRecommendedRestTool': 'Empfohlenes Restwerkzeug verwenden',
  'cam.plan.restStale': 'Die Quelloperation wurde geändert. Aktualisieren Sie die Empfehlungen, um diese Restbearbeitung neu zu berechnen.',
  'cam.plan.sharedSetup': 'Gemeinsame Kontureinrichtung',
  'cam.plan.sharedTabs': 'Gemeinsame Haltestege',
  'cam.plan.sharedBy': 'Einmal für alle passenden Konturzustellungen verwendet',
  'cam.plan.sharedByCount': 'Von {count} Operationen gemeinsam verwendet',
  'cam.plan.reuseTabs': 'Projekt-Haltestege für diese Operationen wiederverwenden',
  'cam.plan.createTabs': '{count} Haltestege einmal für diese Operationen erstellen',
  'cam.plan.tabDimensions': 'Gemeinsame Haltestegmaße',
  'cam.plan.tabWidth': 'Breite',
  'cam.plan.tabHeight': 'Höhe',
  'cam.plan.tabTop': 'Oberes Z',
  'cam.plan.tabSharedNote': 'Eine Änderung aktualisiert alle vorgeschlagenen Haltestege dieser gemeinsamen Anordnung.',
  'cam.plan.tabsDisabledWarning': 'Haltestege sind für diesen Trennschnitt deaktiviert. Bestätigen Sie vor der Bearbeitung eine andere Werkstückspannung.',
  'cam.plan.coverageReview': 'Ausdrückliche Prüfung erforderlich',
  'cam.plan.excludedCoverage': 'Derzeit deckt keine aktivierte Empfehlung dieses Feature ab.',
  'cam.plan.acknowledge': 'Ich verstehe, dass diese Formen von den erstellten Operationen nicht abgedeckt werden.',
  'cam.plan.noRecommendations': 'Keine unterstützten 2,5D-Empfehlungen gefunden.',
  'cam.plan.cancel': 'Abbrechen',
  'cam.plan.createOperations': '{count} Operationen erstellen',
