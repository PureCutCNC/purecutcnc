...
export const camDe: Record<keyof typeof camEn, string> = {
  ...
  'cam.operation.xyLeadTangentS': 'Tangentiale S-Kurve',
  'cam.operation.xyLeadStrategyTooltip': 'Wo das Werkzeug die Endtiefe erreicht und wie es auf den ersten Räumring trifft. „Direkt“ taucht direkt am Ringanfang ein. „Tangentiale S-Kurve“ setzt das Eintauchen abseits des Rings an und fährt tangential auf ihn zu – und vom letzten Ring wieder weg.',
