...
export const camDe: Record<keyof typeof camEn, string> = {
  ...
  'cam.plan.subtitle': 'Prüfen Sie die empfohlenen Operationen, Werkzeuge und gemeinsamen Einstellungen, bevor etwas zum Projekt hinzugefügt wird.',
  ...
  'cam.plan.recalculate': 'Empfehlungen zurücksetzen',
  ...
  'cam.plan.restStale': 'Die Quelloperation wurde geändert. Setzen Sie die Empfehlungen zurück, um diese Restbearbeitung neu zu berechnen.',
