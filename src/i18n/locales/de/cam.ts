...
export const camDe: Record<keyof typeof camEn, string> = {
  ...
  'cam.panel.exportBookletForOperation': 'Broschüre (PDF) für diesen Arbeitsgang exportieren',
  'cam.panel.exportBookletForSelected': 'Broschüre (PDF) für ausgewählten Arbeitsgang exportieren',
  'cam.panel.exportBookletFor': 'Broschüre (PDF) für {name} exportieren',
  ...
  'cam.operation.carveStrategy': 'Strategie',
  'cam.operation.carveStrategyDirect': 'Direkt',
  'cam.operation.carveStrategyTrochoidal': 'Trochoidal (Nut)',
  'cam.operation.carveChannelWidth': 'Kanalbreite',
  'cam.operation.carveChannelWidthNote': 'Trochoidal schneidet einen {width} breiten Kanal, keine werkzeugbreite Nut. Dünner gravierter Text übersteht das nicht.',
  ...
  'cam.operation.group.depth': 'Tiefe',
  'cam.operation.group.feeds': 'Vorschub & Drehzahl',
  'cam.operation.group.strategy': 'Strategie',
  'cam.operation.group.advanced': 'Erweiterte Überschreibungen',
  'cam.operation.group.entry': 'Eintauchen & Rückzug',
  'cam.operation.group.corners': 'Ecken',
  'cam.operation.group.drilling': 'Bohren',
  'cam.operation.group.output': 'Ausgabe',
  'cam.operation.entryStrategy': 'Eintauchstrategie',
  'cam.operation.entryPlunge': 'Senkrecht eintauchen',
  'cam.operation.entryHelix': 'Helix',
  'cam.operation.entryRamp': 'Rampe',
  'cam.operation.entryRampAngle': 'Rampenwinkel (°)',
  'cam.operation.entryHelixDiameter': 'Helixdurchmesser (%)',
  'cam.operation.xyLeadStrategy': 'XY-An- und Abfahrt',
  'cam.operation.xyLeadNone': 'Direkt',
  'cam.operation.xyLeadArc': 'Tangentialer Bogen',
  'cam.operation.xyLeadStrategyTooltip': 'Wo das Werkzeug die Endtiefe erreicht und wie es auf die Kontur trifft. „Direkt“ taucht direkt am Startpunkt ein, was an einer Wand eine Markierung hinterlässt. „Tangentialer Bogen“ setzt das Eintauchen abseits der Fläche an und fährt im Bogen auf sie zu – und wieder weg –, sodass das Werkzeug nie eintauchend ankommt.',
  ...
  'cam.operation.cornerReliefLongestEdge': 'T-Bone, längste Kante',
  'cam.operation.cornerReliefTooltip': 'Schneidet an jeder Innenecke des geräumten Bereichs eine Freistellung, als zusätzlicher gestufter Durchgang nach dem Hauptweg, bemessen nach dem Werkzeug dieser Operation. Dogbone legt die Freistellung auf die Diagonale und nimmt am wenigsten Material ab. T-Bone hält sie stattdessen in einer Fläche und bezahlt das mit einer Nut von einem vollen Fräserradius Tiefe und zwei Radien Breite in dieser Fläche — etwa 2,3× so viel Material wie beim Dogbone. Längste Kante ist T-Bone an der längeren der beiden Wände, wo diese Nut weniger schadet.',
  ...
  'cam.operation.engagementMode': 'Vorschubreduzierung',
  'cam.operation.engagementModeLegacy': 'Nur bei Nuten',
  'cam.operation.engagementModeEngagementFeed': 'Nach Eingriff',
  ...
  'cam.paramRef.scallopHeight': 'Referenz für Riefenhöhe',
  ...
  'cam.paramRef.cornerRelief': 'Referenz Eckenfreistellung',
