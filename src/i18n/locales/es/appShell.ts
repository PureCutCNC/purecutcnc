...
export const appShellEs: Record<keyof typeof appShellEn, string> = {
  ...
  'appShell.toolpath.rendererFallback': 'GPU no disponible; se usa Canvas.',
  'appShell.toolpath.rendererRetry': 'Reintentar GPU',
  ...
  'appShell.panel.showProject': 'Mostrar panel de proyecto',
  'appShell.panel.hideProject': 'Ocultar panel de proyecto',
  'appShell.panel.showCam': 'Mostrar panel CAM',
  'appShell.panel.hideCam': 'Ocultar panel CAM',
  ...
  'appShell.status.editStockDimensions': 'Editar dimensiones del material en bruto',
  ...
  // Estado de generación y backend de ejecución (issue #675).
  'appShell.generation.ready': 'Trayectorias al día',
  'appShell.generation.working': 'Generando ({count})',
  'appShell.generation.paused': 'Generación en pausa',
  'appShell.generation.failed': 'Error de generación',
  'appShell.generation.stop': 'Detener',
  'appShell.generation.stopUnavailable': 'Detener no puede interrumpir una operación que ya se está ejecutando en el hilo principal.',
  'appShell.generation.resume': 'Reanudar',
  'appShell.generation.retry': 'Reintentar',
  'appShell.generation.backend': 'Cálculo',
  'appShell.generation.menuAria': 'Ajustes de generación de trayectorias',
  'appShell.generation.backendInline': 'Hilo principal',
  'appShell.generation.backendInlineDetail': 'La ventana no responde mientras se genera una operación, y Detener tiene que esperar a que termine.',
  'appShell.generation.backendWorker': 'Hilo en segundo plano (experimental)',
  'appShell.generation.backendWorkerDetail': 'Mantiene la ventana receptiva durante la generación y hace que Detener surta efecto de inmediato.',
