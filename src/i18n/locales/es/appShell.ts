...
export const appShellEs: Record<keyof typeof appShellEn, string> = {
  "appShell.workspace.sketch": "bosquejo",
  ...
  "appShell.status.featureLabels": "Etiquetas de características",
  "appShell.status.showFeatureLabels": "Mostrar etiquetas de características",
  "appShell.status.hideFeatureLabels": "Ocultar etiquetas de características",
  "appShell.status.grid": "Cuadrícula",
  "appShell.status.showGrid": "Mostrar cuadrícula",
  "appShell.status.hideGrid": "Ocultar cuadrícula",
  "appShell.status.stock": "Valores",
  "appShell.status.showStock": "Mostrar existencias",
  "appShell.status.hideStock": "Ocultar acciones",
  ...
  "appShell.status.clamps": "Abrazaderas",
  "appShell.status.noClamps": "Sin abrazaderas en proyecto",
  "appShell.status.showClamps": "Mostrar abrazaderas",
  "appShell.status.hideClamps": "Ocultar abrazaderas",
  ...
  "appShell.toolpath.plunges": "zambullidas",
  ...
  "appShell.toolRail.offset": "compensación",
  "appShell.toolRail.constraint": "Restricción",
  "appShell.toolRail.join": "Unirse",
