...
export const viewportEs: Record<keyof typeof viewportEn, string> = {
  ...
  'viewport.sim.engagementLabel': 'Compromiso',
  'viewport.sim.engagementTooltip': 'Porcentaje de compromiso de la herramienta. 100 % = compromiso total de ranura (avance reducido), menor = menos compromiso (avance completo).',
  'viewport.sim.playbackTitle': 'Reproducción de herramienta',
