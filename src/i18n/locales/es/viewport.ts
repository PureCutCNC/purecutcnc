...
export const viewportEs: Record<keyof typeof viewportEn, string> = {
  ...
  'viewport.view3d.webglUnavailableTitle': 'La vista 3D no está disponible',
  'viewport.view3d.webglUnavailableBody': 'Esta vista requiere WebGL2, que su navegador o controlador de gráficos no proporcionó. Intente actualizar su navegador o habilitar la aceleración de hardware en su configuración.',
  'viewport.view3d.webglLostTitle': 'Se perdió el contexto de los gráficos 3D',
  'viewport.view3d.webglLostBody': 'Esperando a que el navegador lo restaure. Si este mensaje persiste, recarga la aplicación.',
  ...
  'viewport.empty.importMeta': 'Archivos SVG, DXF, STL, OBJ, STEP o CAMJ',
