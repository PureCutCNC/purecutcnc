...
export const themeManagerEs: Record<keyof typeof themeManagerEn, string> = {
  ...
  "themeManager.lightSlot": "Claro Tema",
  ...
  "themeEditor.previewingLive": "Previsualizando tus ediciones en tiempo real.",
  "themeEditor.colorsWrong": "¿Los colores no se ven bien?",
  "themeEditor.restoreSaved": "Restaurar colores guardados",
  "themeEditor.basedOn.one": "Se cambió el color según {base} · {count}",
  "themeEditor.basedOn.other": "Se cambió el color según {base} · {count}\nSe cambiaron los colores según",
  ...
  "themeEditor.contrastNote": "Verificaciones aleatorias automatizadas del representante estados — cobertura WCAG incompleta.",
  ...
  "themeEditor.resetFieldAria": "Restablecer {label} al valor base Valor",
  ...
  "themePreview.danger": "Peligro: colisión de pinza detectada.",
  "themePreview.canvasTitle": "Lienzo de boceto",
