...
export const bookletEs: Record<keyof typeof bookletEn, string> = {
  ...
  "booklet.operation.vCarve": "Tallado en V",
  "booklet.operation.vCarveMedial": "Tallado en V medial",
  "booklet.operation.insideEdgeRoute": "Fresado de borde interior",
  "booklet.operation.outsideEdgeRoute": "Fresado de borde exterior",
  "booklet.operation.surfaceClean": "Planeado de superficie",
  ...
  "booklet.machiningOrder.featureFirst": "Primero por entidad",
  "booklet.machiningOrder.levelFirst": "Primero por nivel",
  "booklet.target.stock": "Material en bruto",
  "booklet.target.missingFeature": "Característica faltante {id}",
  ...
  "booklet.label.pocketAngle": "Ángulo de la cavidad",
