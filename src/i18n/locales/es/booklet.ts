...
export const bookletEs: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.edgeStrategy.contour': 'Contorno',
  'booklet.edgeStrategy.trochoidal': 'Trocoidal',
  'booklet.cornerRelief.dogbone': 'Hueso de perro',
  'booklet.cornerRelief.tBone': 'Hueso en T (ranura de un radio completo de fresa en una pared)',
  'booklet.cornerRelief.longestEdge': 'Hueso en T en la arista más larga (ranura de un radio completo de fresa en esa pared)',
  'booklet.carveStrategy.trochoidal': 'Trocoidal (ranura)',
  'booklet.engagementMode.engagementFeed': 'Por acoplamiento',
  ...
  'booklet.label.edgeStrategy': 'Estrategia',
  'booklet.label.trochoidalCutWidth': 'Anchura de corte trocoidal',
  'booklet.label.trochoidalAdvance': 'Avance por vuelta',
  ...
  'booklet.label.entryStrategy': 'Estrategia de entrada',
  'booklet.label.xyLeadStrategy': 'Aproximación y salida XY',
  'booklet.entryStrategy.helix': 'Helicoidal',
  'booklet.entryStrategy.ramp': 'Rampa',
  ...
  'booklet.label.engagementMode': 'Reducción de avance',
