...
export const warningsEs: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.carveTrochoidalMoveBudget': 'El grabado trocoidal supera el presupuesto de 500.000 puntos de la operación cerca de ({x}, {y}).',
  'warnings.carveTrochoidalEntryBudget': 'La entrada del grabado trocoidal cerca de ({x}, {y}) supera el presupuesto de puntos de entrada.',
  ...
  'warnings.drillRetractBelowStockTop': 'La altura de retracción ({requested}) está por debajo de la cara superior del material; elevada a {clamped} para que la herramienta no entre en la pieza en avance rápido. La altura de retracción se guarda como una distancia sobre la superficie del material (issue #481).',
