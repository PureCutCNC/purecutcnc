...
export const warningsEs: Record<keyof typeof warningsEn, string> = {
  ...
  "warnings.postArcNoCapability": "La operación \"{operation}\" contiene segmentos de trayectoria circular pero la máquina seleccionada no admite interpolación circular (G2/G3). Se emiten movimientos lineales en su lugar.",
