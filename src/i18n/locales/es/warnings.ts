...
export const warningsEs: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.edgeTrochoidalWidthTooSmall': 'La anchura de corte trocoidal debe ser como mínimo 1,15 veces el diámetro de la herramienta.',
  'warnings.edgeTrochoidalWidthNarrow': 'La anchura de corte trocoidal es estrecha; se recomienda 1,25 veces el diámetro de la herramienta o más.',
  'warnings.edgeTrochoidalWidthLeavesCore': 'El ancho de corte trocoidal supera el doble del diámetro de la herramienta; cada entrada helicoidal deja un núcleo sin cortar que los bucles siguientes deben arrancar. Reduzca el ancho de corte o pretaladre la entrada.',
  ...
  'warnings.edgeTrochoidalAdvanceDegenerate': 'El avance trocoidal cerca de ({x}, {y}) es demasiado pequeño para esta fresa: la órbita avanza menos del 1 % del diámetro de la herramienta por vuelta y vuelve a cortar el mismo material en lugar de progresar. Aumente el avance por vuelta.',
  'warnings.edgeTrochoidalMoveBudget': 'El fresado trocoidal necesita más puntos de los que permite una operación. Aumente el avance por vuelta, aumente la profundidad de pasada para tener menos niveles en Z o use una fresa más grande.',
  'warnings.edgeTrochoidalEntryBudget': 'La entrada trocoidal cerca de ({x}, {y}) no cabe en el presupuesto de puntos que le queda a la operación. Aumente el avance por vuelta, aumente la profundidad de pasada para tener menos niveles en Z o use una fresa más grande.',
  ...
  'warnings.carveTrochoidalWidthTooSmall': 'La anchura de corte del grabado trocoidal debe ser como mínimo 1,15 veces el diámetro de la herramienta.',
  'warnings.carveTrochoidalWidthNarrow': 'La anchura de corte del grabado trocoidal es estrecha; se recomienda 1,25 veces el diámetro de la herramienta o más.',
  'warnings.carveTrochoidalWidthLeavesCore': 'El ancho de corte del grabado trocoidal supera el doble del diámetro de la herramienta; cada entrada helicoidal deja un núcleo sin cortar que los bucles siguientes deben arrancar. Reduzca el ancho de corte o pretaladre la entrada.',
  'warnings.carveTrochoidalAdvanceRange': 'El avance del grabado trocoidal debe ser mayor que 0 y no superar un diámetro de herramienta.',
  'warnings.carveTrochoidalEntryStrategyUnsupported': 'El grabado trocoidal solo admite entrada helicoidal o por penetración.',
  'warnings.carveTrochoidalInvalidGuide': 'La trayectoria de grabado cerca de ({x}, {y}) no es una guía trocoidal válida.',
  'warnings.carveTrochoidalAdvanceDegenerate': 'El avance del grabado trocoidal cerca de ({x}, {y}) es demasiado pequeño para esta fresa: la órbita avanza menos del 1 % del diámetro de la herramienta por vuelta y vuelve a cortar el mismo material en lugar de progresar. Aumente el avance por vuelta.',
  ...
  'warnings.pocketTrochoidalWidthTooSmall': 'El ancho de corte trocoidal del bolsillo {width} está por debajo del mínimo {minimum} (1,15 veces el diámetro de la herramienta). Amplíe el canal o use una fresa más pequeña.',
  'warnings.pocketTrochoidalWidthLeavesCore': 'El ancho de corte trocoidal del bolsillo {width} supera el doble del diámetro de la herramienta, por lo que la entrada helicoidal ya no se solapa con su propio centro y deja un núcleo sin cortar. Reduzca el ancho del canal.',
  'warnings.pocketTrochoidalStepoverHigh': 'Un paso de {stepover} separa los anillos trocoidales {pitch} en un canal de {width}, lo que puede dejar material sin cortar entre ellos. Medido en un bolsillo de ángulo recto, {limit} fue el máximo que aún limpiaba por completo; con esquinas más agudas queda material incluso por debajo de ese valor. Reduzca el paso o revise el resultado.',
  'warnings.pocketTrochoidalCornerReliefUnsupported': 'El alivio de esquina ({style}) no se aplica en un bolsillo trocoidal: la órbita nunca recorre la esquina del anillo sobre la que desciende el pase de alivio. Quite el ajuste o use un patrón de contorno.',
  'warnings.pocketTrochoidalTightSpot': 'El paso estrecho cerca de ({x}, {y}) no admite el canal trocoidal de {width}, por lo que no se generó ninguna pasada y queda material sin cortar. Reduzca el ancho del canal, use una fresa más pequeña o limpie esa zona con un patrón de contorno.',
  ...
  'warnings.drillSkippedUnderClamp': '{name} está bajo la mordaza «{clamp}»; se omite: una penetración no puede elevarse por encima de una mordaza',
  ...
  'warnings.clampBlockedCut': 'La trayectoria se mantuvo alejada de la mordaza «{name}»: el material debajo de ella y dentro de su holgura queda sin mecanizar.',
  ...
  'warnings.postToolChangesDisabled': 'La operación "{operation}" necesita la herramienta "{tool}", pero los cambios de herramienta están deshabilitados: el programa sigue cortando con la herramienta anterior. Active los cambios de herramienta o exporte una operación a la vez.',
  ...
  'warnings.restTrochoidalUnsupported': 'El mecanizado de restos no está disponible para el fresado de borde trocoidal porque su canal barrido aún no puede representarse como una región de restos.',
}
