...
export const viewportZhCN: Record<keyof typeof viewportEn, string> = {
  ...
  'viewport.view3d.webglUnavailableTitle': '3D 视图不可用',
  'viewport.view3d.webglUnavailableBody': '此视图需要 WebGL2，但您的浏览器或显卡驱动未提供。请尝试更新浏览器或在设置中启用硬件加速。',
  'viewport.view3d.webglLostTitle': '3D 图形上下文丢失',
  'viewport.view3d.webglLostBody': '正在等待浏览器恢复。如果此消息持续显示，请重新加载应用。',
