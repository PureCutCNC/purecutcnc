...
export const dialogsZhCN: Record<keyof typeof dialogsEn, string> = {
  ...
  'dialogs.newProject.stockSize': '毛坯尺寸（{units}）',
  'dialogs.newProject.stockWidth': '宽度',
  'dialogs.newProject.stockHeight': '高度',
  'dialogs.newProject.stockThickness': '厚度',
  'dialogs.newProject.stockDimensionsInvalid': '请输入正的毛坯尺寸。',
  ...
  'dialogs.importGeometry.chooseFile': '选择 SVG、DXF、STL、OBJ、STEP 或 .camj',
  ...
  'dialogs.importGeometry.stepTolerance': '曲面公差（{unit}）',
  'dialogs.importGeometry.stepUnitsDeclared': '文件中声明的单位：{units}',
  'dialogs.importGeometry.stepUnitsConverted': '文件声明的单位为 {units}；几何体将转换为毫米。',
  ...
  'dialogs.importGeometry.error.unsupportedFormat': '不支持的导入格式。请使用 .svg、.dxf、.stl、.obj、.step、.stp 或 .camj。',
  'dialogs.importGeometry.error.noCamjFolders': '所选 .camj 文件中未找到包含特征的文件夹。',
  'dialogs.importGeometry.error.inspectFailed': '检查图形文件失败。',
  'dialogs.importGeometry.error.chooseFile': '选择要导入的 SVG、DXF、STL、OBJ、STEP 或 .camj 文件。',
  ...
  'dialogs.importGeometry.error.stepTolerance': '曲面公差必须为正数。',
  'dialogs.importGeometry.error.stepFileTooLarge': '无法导入大于 {limit} MB 的 STEP 文件。',
  'dialogs.importGeometry.error.stepRuntimeUnavailable': '无法加载 STEP 导入器。请检查网络连接后重试。',
  'dialogs.importGeometry.error.stepUnreadable': '无法读取该 STEP 文件。',
  'dialogs.importGeometry.error.stepNoGeometry': '该 STEP 文件不包含可导入的实体或曲面。',
  'dialogs.importGeometry.error.stepTooManyTriangles': '模型网格化后超过 {limit} 个三角形。请增大曲面公差后重试。',
  'dialogs.importGeometry.error.stepOutOfMemory': 'STEP 导入器内存不足。请增大曲面公差或导入更小的模型。',
  'dialogs.importGeometry.error.stepTessellationFailed': '无法对该 STEP 模型进行网格化。',
  'dialogs.importGeometry.error.stepWorkerFailed': 'STEP 导入器意外停止。请重试。',
  'dialogs.importGeometry.error.stepDetail': '{message} 详细信息：{detail}',
  ...
  'dialogs.importGeometry.tessellatingStep': '正在对 STEP 模型进行网格化',
  ...
  'dialogs.export.error.generationFailed': '“{operation}”的生成失败：{detail}',
  'dialogs.export.error.generationInterrupted': '“{operation}”的生成已取消或被取代。请更改选择或某个选项，然后重新导出。',
  'dialogs.export.error.missingTool': '加工操作“{operation}”未指定刀具。',
  'dialogs.export.error.stale': '导出预览已过期。请重新打开对话框并重试。',
  ...
  'dialogs.machineManager.emptyCustom': '尚无自定义机床。请复制一个内置机床或导入一个。',
  'dialogs.machineManager.emptyDetail': '从列表中选择一个机床或导入一个。',
  'dialogs.machineManager.invalidImport': '无效的机床定义 JSON：{message}',
  'dialogs.machineManager.builtinGroup': '内置机床',
  'dialogs.machineManager.myMachines': '我的机床',
  'dialogs.machineManager.projectGroup': '本项目中',
  'dialogs.machineManager.notInLibrary': '不在“我的机床”中',
  'dialogs.machineManager.updateAvailable': '有可用更新',
  'dialogs.machineManager.updateProjectCopy': '更新项目副本',
  'dialogs.machineManager.saveToMyMachines': '保存到“我的机床”',
  'dialogs.machineManager.projectCopyHint': '此机床随项目一起保存。即使它不在您的机床库中，仍可用于导出。',
  'dialogs.machineManager.comparisonTitle': '此项目使用的副本与库中不同',
  'dialogs.machineManager.comparisonBodyBuiltin': '项目中“{name}”的副本与本版本 PureCutCNC 的内置定义不同。更新它可能会改变导出的 G 代码。',
  'dialogs.machineManager.comparisonBodyCustom': '项目中“{name}”的副本与您保存在“我的机床”中的副本不同。更新它可能会改变导出的 G 代码。',
  'dialogs.machineManager.comparisonFields': '差异：{fields}',
  'dialogs.machineManager.field.id': '标识符',
  'dialogs.machineManager.field.name': '名称',
  ...
  'dialogs.machineManager.field.program': '程序头尾',
  'dialogs.machineManager.field.workCoordinates': '工件坐标系',
  'dialogs.machineManager.field.motion': '运动指令',
  'dialogs.machineManager.field.feedSpeed': '进给与主轴',
  'dialogs.machineManager.field.toolChange': '换刀',
  'dialogs.machineManager.field.cannedCycles': '固定循环',
  'dialogs.machineManager.field.coolant': '冷却液',
  'dialogs.machineManager.field.stop': '程序结束',
  'dialogs.machineManager.field.builtin': '归属',
  'dialogs.machineUpdate.title': '机床定义有可用更新',
  'dialogs.machineUpdate.body': '此项目使用的是“{name}”的较旧副本。更新它可能会改变导出的 G 代码。',
  'dialogs.machineUpdate.review': '查看更新',
  'dialogs.machineUpdate.keep': '保留项目副本',
  'dialogs.machineUpdate.update': '更新项目副本',
}
