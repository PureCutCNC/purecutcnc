...
export const dialogsZhCN: Record<keyof typeof dialogsEn, string> = {
  ...
  'dialogs.motionDebug.fit': '适配',
  'dialogs.motionDebug.reset': '重置',
  'dialogs.motionDebug.zoomSelection': '缩放选区',
  'dialogs.motionDebug.perLevel': '按层级',
  'dialogs.motionDebug.rawMoves': '原始运动',
  'dialogs.motionDebug.optimizedMoves': '优化运动',
  'dialogs.motionDebug.removed': '已移除',
  'dialogs.motionDebug.linear': '直线',
  'dialogs.motionDebug.rapid': '快速',
  'dialogs.motionDebug.arcCw': '顺时针圆弧',
  'dialogs.motionDebug.arcCcw': '逆时针圆弧',
  'dialogs.motionDebug.verified': '已验证 — 导出运动在公差范围内与生成路径一致。',
  'dialogs.motionDebug.warning': '警告',
  'dialogs.motionDebug.ineligibleDrilling': '钻孔操作无法显示为 2D 平面轨迹。',
  'dialogs.motionDebug.ineligibleNoCut': '此操作没有可检查的切削运动。',
  'dialogs.motionDebug.ineligibleVariableZ': '此操作的切削 Z 连续变化，无法显示为平坦的 2.5D 轨迹。',
