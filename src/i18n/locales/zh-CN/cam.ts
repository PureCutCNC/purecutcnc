...
export const camZhCN: Record<keyof typeof camEn, string> = {
  ...
  'cam.operation.carveStrategy': '策略',
  'cam.operation.carveStrategyDirect': '直接',
  'cam.operation.carveStrategyTrochoidal': '摆线（槽）',
  'cam.operation.carveChannelWidth': '通道宽度',
  'cam.operation.carveChannelWidthNote': '摆线切削产生 {width} 宽的通道，而非刀具宽度的槽。细雕刻文字无法承受。',
  ...
  'cam.operation.entry': '下刀',
  'cam.operation.entryStrategy': '下刀方式',
  'cam.operation.entryPlunge': '垂直下刀',
  'cam.operation.entryHelix': '螺旋下刀',
  'cam.operation.entryRamp': '斜坡下刀',
  'cam.operation.entryRampAngle': '斜坡下刀角度（°）',
  'cam.operation.entryHelixDiameter': '螺旋下刀直径（%）',
  ...
  'cam.operation.cornerReliefTBone': 'T 形',
  'cam.operation.cornerReliefLongestEdge': 'T 形（最长边）',
  'cam.operation.cornerReliefTooltip': '在清除区域的每个内拐角切出让位，作为主路径之后的一个额外分层行程，尺寸根据本操作的刀具确定。狗骨形将让位放在对角线上，去除的材料最少。T 形将其限制在单一面内，代价是在该面上留下一个深一个刀具半径、宽两个半径的槽，大约是狗骨形的 2.3 倍材料。最长边则是在两面中较长的一面做 T 形，那里的槽损害更小。',
  ...
  'cam.paramRef.entryStrategy': '下刀方式参考',
  ...
  'cam.paramRef.cornerRelief': '拐角让位参考图',
  ...
  // ── 库导入对话框 ──
  'cam.tools.dialogTitle': '从库导入刀具',
  'cam.tools.searchPlaceholder': '按名称或直径搜索…',
  'cam.tools.searchAria': '搜索刀具库',
  'cam.tools.inProject': '已在项目中',
  'cam.tools.new': '新建',
  'cam.tools.selectedCount.one': '已选择 1 把刀具',
  'cam.tools.selectedCount.other': '已选择 {count} 把刀具',
  'cam.tools.importAction.one': '导入刀具',
  'cam.tools.importAction.other': '导入 {count} 把刀具',
  'cam.tools.loadingDialog': '正在加载刀具库…',
  'cam.tools.retry': '重试',
  'cam.tools.noMatch': '没有库刀具匹配当前筛选条件。',
  'cam.tools.clearFilters': '清除筛选',
