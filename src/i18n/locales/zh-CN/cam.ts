...
export const camZhCN: Record<keyof typeof camEn, string> = {
  ...
  'cam.operation.xyLeadTangentS': '相切 S 曲线',
  'cam.operation.xyLeadStrategyTooltip': '刀具在何处到达最终深度，以及如何切入第一条清角环。“直接”会直接下到环的起点。“相切 S 曲线”会让下刀点避开环，再沿相切曲线切入该环，并以同样方式离开最后一条环。',
