...
export const bookletZhCN: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.cornerRelief.dogbone': '狗骨形',
  'booklet.cornerRelief.tBone': 'T 形（在单侧壁面切出一个刀具半径深的槽）',
  'booklet.cornerRelief.longestEdge': '最长边 T 形（在该壁面切出一个刀具半径深的槽）',
  'booklet.carveStrategy.trochoidal': '摆线（槽）',
  'booklet.engagementMode.engagementFeed': '按啮合',
  ...
  'booklet.label.edgeStrategy': '策略',
  'booklet.label.trochoidalCutWidth': '摆线切削宽度',
  'booklet.label.trochoidalAdvance': '每圈推进量',
  ...
  'booklet.label.entryStrategy': '下刀方式',
  'booklet.label.xyLeadStrategy': 'XY 进退刀',
  'booklet.entryStrategy.helix': '螺旋下刀',
  'booklet.entryStrategy.ramp': '斜坡下刀',
  'booklet.xyLead.arc': '相切圆弧',
  ...
  'booklet.label.engagementMode': '降低进给',
