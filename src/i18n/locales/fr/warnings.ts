...
export const warningsFr: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.edgeTrochoidalParametersInvalid': 'Le fraisage trochoïdal exige des valeurs positives pour l’avance, l’avance de plongée, le régime et la profondeur de passe.',
