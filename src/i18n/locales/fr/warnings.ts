...
export const warningsFr: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.pocketTrochoidalStepoverHigh': 'Un pas de {stepover} espace les anneaux trochoïdaux de {pitch} dans un canal de {width}, ce qui peut laisser de la matière non coupée entre eux. Mesuré sur une poche à angles droits, {limit} était la valeur maximale qui dégageait encore entièrement ; avec des angles plus aigus, de la matière subsiste même en dessous. Réduisez le pas ou vérifiez le résultat.',
  'warnings.pocketTrochoidalCornerReliefUnsupported': 'Le dégagement d’angle ({style}) n’est pas appliqué sur une poche trochoïdale : l’orbite ne suit jamais l’angle de l’anneau sur lequel la passe de dégagement descend. Retirez le réglage ou utilisez un motif de contour.',
  'warnings.pocketTrochoidalTightSpot': 'Le passage près de ({x}, {y}) est trop étroit pour le canal trochoïdal de {width} : aucune passe n’y a été générée et de la matière subsiste. Réduisez la largeur du canal, utilisez une fraise plus petite, ou dégagez cette zone avec un motif de contour.',
  ...
  'warnings.surface3dOpenMesh': 'Le modèle comporte des tranches ouvertes/non étanches ; une opération de surface a utilisé une protection de silhouette prudente',
  ...
  'warnings.drillSkippedUnderClamp': '{name} se trouve sous la bride «\u00A0{clamp}\u00A0» ; ignoré — une plongée ne peut pas être relevée au-dessus d’une bride',
  ...
  'warnings.clampBlockedCut': 'Le parcours a été écarté de la bride « {name} » — la matière sous celle-ci et dans son dégagement n’est pas usinée.',
