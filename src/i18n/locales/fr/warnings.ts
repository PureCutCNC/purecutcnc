...
export const warningsFr: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.carveTrochoidalMoveBudget': 'La gravure trochoïdale dépasse le budget de 500\u00A0000 points de l’opération près de ({x}, {y}).',
  'warnings.carveTrochoidalEntryBudget': 'L’entrée de la gravure trochoïdale près de ({x}, {y}) dépasse le budget de points d’entrée.',
