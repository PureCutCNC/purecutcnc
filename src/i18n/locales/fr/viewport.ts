...
export const viewportFr: Record<keyof typeof viewportEn, string> = {
  ...
  'viewport.view3d.webglUnavailableTitle': 'La vue 3D n’est pas disponible',
  'viewport.view3d.webglUnavailableBody': 'Cette vue nécessite WebGL2, que votre navigateur ou pilote graphique ne fournit pas. Essayez de mettre à jour votre navigateur ou d’activer l’accélération matérielle dans ses paramètres.',
  'viewport.view3d.webglLostTitle': 'Contexte graphique 3D perdu',
  'viewport.view3d.webglLostBody': 'En attente de sa restauration par le navigateur. Si ce message persiste, rechargez l’application.',
  ...
  'viewport.empty.importMeta': 'Fichiers SVG, DXF, STL, OBJ, STEP ou CAMJ',
