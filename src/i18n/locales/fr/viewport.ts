...
export const viewportFr: Record<keyof typeof viewportEn, string> = {
  ...
  'viewport.sim.engagementLabel': 'Engagement',
  'viewport.sim.engagementTooltip': 'Pourcentage d’engagement de l’outil. 100 % = engagement plein (avance réduite), moins = moins d’engagement (avance pleine).',
  'viewport.sim.playbackTitle': 'Lecture de l’outil',
