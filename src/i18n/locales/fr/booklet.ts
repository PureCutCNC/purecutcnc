...
export const bookletFr: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.cornerRelief.dogbone': 'Os de chien',
  'booklet.cornerRelief.tBone': 'Os en T (rainure d’un rayon de fraise complet dans une paroi)',
  'booklet.cornerRelief.longestEdge': 'Os en T sur l’arête la plus longue (rainure d’un rayon de fraise complet dans cette paroi)',
  'booklet.carveStrategy.trochoidal': 'Trochoïdale (rainure)',
  'booklet.engagementMode.engagementFeed': 'Selon l’engagement',
  ...
  'booklet.label.edgeStrategy': 'Stratégie',
  'booklet.label.trochoidalCutWidth': 'Largeur de coupe trochoïdale',
  'booklet.label.trochoidalAdvance': 'Avance par boucle',
  ...
  'booklet.label.entryStrategy': 'Stratégie d’entrée',
  'booklet.label.xyLeadStrategy': 'Approche et sortie XY',
  'booklet.entryStrategy.helix': 'Hélicoïdale',
  'booklet.entryStrategy.ramp': 'Rampe',
  'booklet.xyLead.arc': 'Arc tangent',
  ...
  'booklet.label.engagementMode': 'Réduction d’avance',
