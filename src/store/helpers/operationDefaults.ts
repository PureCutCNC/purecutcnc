...
export function defaultOperationName(kind: OperationKind, pass: OperationPass, operations: Operation[]): string {
  const baseName = kind === 'follow_line' || kind === 'v_carve' || kind === 'v_carve_recursive' || kind === 'v_carve_medial' || kind === 'drilling' || kind === 'rough_surface' || kind === 'finish_surface'
...
export function defaultOperationForTarget(
  ...
  const isVCarve = kind === 'v_carve' || kind === 'v_carve_recursive' || kind === 'v_carve_medial'
